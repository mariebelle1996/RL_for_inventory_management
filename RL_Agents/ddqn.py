# -*- coding: utf-8 -*-
"""
Created on Thu Jul 22 00:47:34 2021
...
def ddqn(env, num_episodes, gamma=0.99, lr=1e-3, min_episodes=20, eps=1, eps_decay=0.995, eps_min=0.01, update_step=4, batch_size=64, update_repeats=50, seed=42, max_memory_size=50000, lr_gamma=0.9, lr_step=100, measure_step=100,
         measure_repeats=100, hidden_dim=64):
    """
    ...
    Q_1 = QNetwork(action_dim=env.action_space.n, state_dim = len(env.observation_space),
                                    hidden_dim=hidden_dim).to(device)
    Q_2 = QNetwork(action_dim=env.action_space.n, state_dim = len(env.observation_space),
                                    hidden_dim=hidden_dim).to(device)
